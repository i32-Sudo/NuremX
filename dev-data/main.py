...
def window_capture(filename, hwnd):
    ...
    # saveDC.BitBlt((int(xmid)-200, int(ymid)-300), (400, 600), mfcDC, (int(xmid)-200, int(ymid)-300), win32con.SRCCOPY)
...
def detect(opt):
    ...
    while(1):
        ...
        windowsid = win32gui.FindWindow(classname,titlename)
        # Set Dataloader
        window_capture("game.jpg", titlename)
...
if __name__ == "__main__":
    ...
    threading.Thread(target=exit_key).start() 